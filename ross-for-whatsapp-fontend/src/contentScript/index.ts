...
function initialize(): void {
  ...
  if (!container) {
    ...
    if (appElement) {
      ...
      appElement.style.paddingTop = container.offsetHeight + 'px'
      appElement.style.paddingBottom = container.offsetHeight + 'px'
    } else {
      document.documentElement.appendChild(container)
      document.documentElement.style.paddingTop = container.offsetHeight + 'px'
